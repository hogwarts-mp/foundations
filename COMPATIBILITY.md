...
This matrix describes Foundations `0.5.0`. “Supported” means the combination is an intended release
...
|---|---|---|---|
| HMP Foundations | `0.5.0` pack and resources | Supported | All twenty-seven resources must use the same version. |
...
Asynchronous resource lifecycle is not a requirement for Foundations `0.5.0`. The current pack still
